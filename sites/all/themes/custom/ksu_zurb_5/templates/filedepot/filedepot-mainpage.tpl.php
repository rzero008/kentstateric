...
<div id="filedepotmodule">
  ...
  <div id="filedepot">
    ...
    <div id="filedepottoolbar" class="filedepottoolbar" style="margin-right:0px;padding:5px;display:none;margin-bottom:1px;">
        ...
        <ul class="button-group">
            ...
            <li>
              <span id="newfolderlink">
                <span class="first-child">
                  <a class="ctools-use-modal ctools-modal-filedepot-newfolder-dialog-style button secondary" href="<?php print url('filedepot/nojs/newfolder'); ?>"><?php echo t('New Folder'); ?></a>
                </span>
              </span>
            </li>
          <?php endif; ?>
          <?php if ($show_upload == 'true'):?>
            <li>
              <span id="newfilelink">
                <span class="first-child">
                  <a class="ctools-use-modal ctools-modal-filedepot-newfile-dialog-style button secondary" href="<?php print url('filedepot/nojs/newfile'); ?>"><?php echo t('New File'); ?></a>
                </span>
              </span>
            </li>
          <?php endif; ?>
      ...
      <div class="filedepottoolbar_searchbox small-6 columns text-right">
        <div class="filedepottoolbar_searchform">
          <form name="fsearch" onSubmit="makeAJAXSearch();return false;">
            <input type="hidden" name="tags" value="">
            <div class="row collapse">
              <div class="small-8 columns">
                <input type="text" size="20" name="query" id="searchquery" class="form-text" value="<?php print $search_query ?>" onClick="this.value='';">
              </div>
              <div class="small-4 columns text-left">
                <div class="postfix">
                  <input type="button" id="searchbutton" class="button secondary postfix" style="width:100%;" value="<?php print t('Search') ?>">
                </div>
              </div>
            </div>
          </form>
